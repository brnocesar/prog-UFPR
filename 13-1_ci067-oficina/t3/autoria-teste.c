...
QUESTAO *adiciona_questao(void); /*inicia a criacao de uma prova, aloca espaco p/ o primeiro item da lista de questoes (tipo QUESTAO) e retorna um ponteiro para este item*/
...
void remove_questao(QUESTAO *removida); /**/
/* _-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_- PROTOTIPOS/CABECALHOS DAS FUNCOES -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_- */
